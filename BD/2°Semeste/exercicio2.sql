...
-- 1)Crie uma tabela chamada "Tbl_Clientes" com os seguintes campos: Id (int, chave prim�ria), Nome (varchar 50), Email (varchar 100), e Telefone (varchar 15).
...
create table Tbl_Clientes(
 ...
 --2) Adicione um novo cliente com Nome "Jo�o Silva", Email "joao@email.com" e Telefone "(11) 1234-5678" � tabela "Tbl_Clientes".
 Insert into Tbl_Clientes Values('Jo�o Silva','joao@email.com', '(@11) 1234-5678');
...
-- 5)Crie uma tabela chamada@ "Tbl_Produtos" com os campos: Id (int, chave prim�ria), Nome (varchar 50), Preco (decimal), e Estoque (int).
...
--6) Adicione um novo produto com Nome "Camiseta", Preco 29.99 e Estoque 100 � tabela "Tbl_Produtos".
...
--8)Atualize o pre�o do produto com Id igual a 1 para 39.99.
UPDATE tbl_Produtos
SET preco = 39.99
WHERE id = 1

--9) Crie uma tabela chamada "Tbl_Pedidos" com os campos: Id (int, chave prim�ria), ClienteId (int, chave estrangeira referenciando a tabela "Clientes"), ProdutoId (int, chave estrangeira referenciando a tabela "Produtos"), Quantidade (int), e DataPedido (date).
...
-- 10) Adicione um novo pedido para o cliente com Id igual a 1, referente ao produto com Id igual a 1, com Quantidade 2 e DataPedido igual a hoje � tabela "Tbl_Pedidos".
...
--13)Crie uma tabela chamada "Tbl_Funcionarios" com os campos: Id (int, chave prim�ria), Nome (varchar 50), Cargo (varchar 50), e Salario (decimal)
...
--14) Adicione um novo funcion�rio com Nome "Maria Santos", Cargo "Gerente" e Salario 5000 � tabela "Funcionarios".
insert into Tbl_Funcionarios values ('Maria Santos','Gerente',5000.0);

--15) Atualize o sal�rio do funcion�rio com Id igual a 1 para 6000.
...
-- 17) Crie uma tabela chamada "Tbl_Vendas" com os campos: Id (int, chave prim�ria), ProdutoId (int, chave estrangeira referenciando a tabela "Produtos"), Quantidade (int), ValorTotal (decimal), e DataVenda (date).
...
-- 18)Adicione uma nova venda referente ao produto com Id igual a 1, com Quantidade 2, ValorTotal 79.98 e DataVenda igual a hoje � tabela "Tbl_Vendas".
